...
@section('content')
    <div class="content">
        ...
        <div class="card-body">
            ...
            <div class="input-group mb-3">
                <a href=""
                    onclick="this.href='/admin/lapkependudukan/cetak-pertanggal/'+document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"
