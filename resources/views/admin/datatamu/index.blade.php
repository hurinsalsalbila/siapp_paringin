...
@section('breadcrumb')
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Data Tamu</a></div>
        </div>
    </div>
@endsection
@section('content')
                    ...
                    <div class="form-group">
                        ...
                        @if ($errors->has('keterangan'))
                            <!-- form validation --> <span
                                class="help-block">{{ $errors->first('keterangan') }}</span>
                        @endif
                    </div>
    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            ...
            @endif
            <div class="col-md-12">
                {{-- <a href="{{ route('admin.datatamu.create') }}" class="btn btn-primary">Tambah Data</a> --}}
                <a href="{{ route('admin.datatamu.cetakpdf') }}" class="btn btn-success" target="_blank">CETAK PDF</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($datatamu as $ids)
                                <tr>
                                    ...
                                    <td>{{ $ids->no_telp }}</td>
                                    <td>{{ $ids->keperluan }}</td>
                                    <td>{{ $ids->keterangan }}</td>
                                    <td>
                                        <a href="/admin/datatamu/edit/{{ $ids->id_tamu }}"
                                            class="btn btn-info">Edit</a>
                                        <a href="/admin/datatamu/hapus/{{ $ids->id_tamu }}"
